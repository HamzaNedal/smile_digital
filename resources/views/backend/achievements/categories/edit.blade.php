            ...
            <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary mt-2 mr-2">
                          ...
                          <form action="{{ route('admin.achievements.category.update',['id'=>$category->id]) }}" method="post" enctype="multipart/form-data">
                              @csrf
                              @method('put')
                              @include('backend.achievements.categories.fields')
